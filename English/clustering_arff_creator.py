...
input_file = open("../data/India/results/AH1_stemmed.txt")
word_freq = open("../data/India/results/AH1_attributes.txt")
output_file = open("../data/India/results/AH1_clustering.arff", "w")
relation = "ah1"
